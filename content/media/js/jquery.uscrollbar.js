...
(function ($) {
    function _uScrollbar(c, s) {
        ...
        this.container.css({
            'overflow': 'hidden',
            'position': 'relative'
        }).contents().wrapAll('<div class="scrollbar-content"></div>');
    ...
    _uScrollbar.prototype.checkScroll = function () {
    ...
    _uScrollbar.prototype.pathSize = function () {
    ...
    _uScrollbar.prototype.scroll = function (v, h) {
        var a = 0;
        var b = 0;
        if (v < 0) {
            v = 0;
    ...
    _uScrollbar.prototype.easeScroll = function (v, h) {
        var n = 0;
    ...
    _uScrollbar.prototype.fixFn = function (f, s) {
        var a = this;
        return function () {
            f.apply(s || a, Array.prototype.slice.call(arguments));
        }
    };
    _uScrollbar.prototype.bindEvent = function (t, e, f, s) {
        return t.bind(e, this.fixFn(f, s));
    };
    _uScrollbar.prototype.init = function () {
